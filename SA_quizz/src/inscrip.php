...
include('cnx.php');
    ...
    if(isset($_FILES['image']) AND !empty($_FILES['image']['name'])){
          ...
          $nomImage = $_FILES['image']['name'];
            ...
            if ($row==0) {
             $sql= mysqli_query($conn,"INSERT INTO utilisateur(pass,prenom,Nom,Login,image,statut,privilege) VALUES('".$pass."','".$prenom."','".$nom."','".$login."','".$image."',1,'joueur')");
             $sql= mysqli_query($conn,"INSERT INTO score(score,Login) VALUES(0,'".$login."')");
